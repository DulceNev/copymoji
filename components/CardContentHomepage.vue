...
<template>
    <div class="group">
        <div class="w-60 h-[25rem] p-5 text-center flex flex-col items-center justify-between bg-white rounded-xl">

            <div class="overflow-hidden rounded-full size-40 border-4 border-white shadow-sm flex-shrink-0">
